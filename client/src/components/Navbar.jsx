...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white text-green-600 flex justify-between items-center px-5 py-3 border-b border-gray-200 shadow-sm relative">
      <div className="text-xl font-bold">Bool BnB</div>
      <button
